...
const coffeeshop: Project = new Project("Coffeeshop", "Group project from JavaScript course at Medieinstitutet, creating a webshop based on a classmates design", "/coffeeshop.png", "https://github.com/fridapalms/coffee-webshop.git", "https://fridapalms-coffeeshop.vercel.app/", "#");
...
const todolist: Project = new Project("To do-list", "Assignment from JavaScript course at Medieinstitutet, creating a to do-list using localStorage", "/todolist.png", "https://github.com/fridapalms/the-todos.git", "https://fridapalms.github.io/the-todos/", "#");
